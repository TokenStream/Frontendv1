...
const testimonials: TestimonialTypes[] = [
    {
        message:
            "StreamFlow has completely transformed how we manage subscriptions. It's easy to use and has saved us valuable time and resources.",
        name: "John Doe",
        title: "CEO, Tech Innovations Inc."
    },
    {
        message:
            "The rewards distribution feature of StreamFlow has significantly improved user engagement on our platform. It's a game-changer!",
        name: "Emily Smith",
        title: "Marketing Director, Digital Solutions Ltd."
    },
    {
        message: "Managing salary distributions has never been easier thanks to StreamFlow. It's reliable, efficient, and has streamlined our payroll processes.",
        name: "Michael Johnson",
        title: "HR Manager, Global Enterprises Corp."
    },
    {
        message:
            "StreamFlow's subscription management service is top-notch. It's helped us automate our billing processes and provided a seamless experience for our customers.",
        name: "Sarah Williams",
