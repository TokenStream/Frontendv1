...
const useGetUserSubscriptions = (address: any) => {
    ...
    useEffect(() => {
        ...
        wssProvider.getLogs({ ...subCreatedFilter, fromBlock: 5864071 }).then((events) => {
        ...
        wssProvider.getLogs({ ...subPausedFilter, fromBlock: 5864071 }).then((events) => {
        ...
        wssProvider.getLogs({ ...subResumedFilter, fromBlock: 5864071 }).then((events) => {
